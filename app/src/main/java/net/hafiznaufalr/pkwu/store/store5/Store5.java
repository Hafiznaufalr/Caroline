...
import net.hafiznaufalr.pkwu.store.store4.Detail4;
...
public class Store5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Gelombang Cinta");
    ...
    private void setProduct() {
        ...
        grdProduct.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivity(new Intent(net.hafiznaufalr.pkwu.store.store5.Store5.this, Detail5.class));
            }
        });
    }
