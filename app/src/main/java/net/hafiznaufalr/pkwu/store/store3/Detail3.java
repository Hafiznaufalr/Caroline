package net.hafiznaufalr.pkwu.store.store3;
...
public class Detail3 extends AppCompatActivity implements BaseSliderView.OnSliderClickListener, ViewPagerEx.OnPageChangeListener{
    ...
    private void checkout() {
        dialog = new Dialog(net.hafiznaufalr.pkwu.store.store3.Detail3.this);
        ...
        btnPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                startActivity(new Intent(net.hafiznaufalr.pkwu.store.store3.Detail3.this, Cart.class));
                finish();
            }
        });
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        file_maps.put("Gambar1",R.drawable.s3);
        file_maps.put("Gambar2",R.drawable.s3);
        file_maps.put("Gambar3",R.drawable.s3);
        file_maps.put("Gambar4", R.drawable.s3);
