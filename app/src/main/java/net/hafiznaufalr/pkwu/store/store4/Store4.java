...
import net.hafiznaufalr.pkwu.store.store3.Detail3;
...
public class Store4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Daun Kuping Gajah");
    ...
    private void setProduct() {
        ...
        grdProduct.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivity(new Intent(net.hafiznaufalr.pkwu.store.store4.Store4.this, Detail4.class));
            }
        });
    }
