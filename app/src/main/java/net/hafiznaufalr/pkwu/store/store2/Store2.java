...
import net.hafiznaufalr.pkwu.store.store1.Detail1;
...
public class Store2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Begonia Iron Cross");
    ...
    private void setProduct() {
        ...
        grdProduct.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivity(new Intent(net.hafiznaufalr.pkwu.store.store2.Store2.this, Detail2.class));
            }
        });
    }
